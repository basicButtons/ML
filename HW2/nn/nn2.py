...
with open("/Users/maxuan/Desktop/course/ML/HW2/data/train1.csv",'r') as f:
    reader = csv.reader(f)
    for row in reader:
        train_x.append(row[0:20])
        train_y.append(row[20])

with open("/Users/maxuan/Desktop/course/ML/HW2/data/test_1.csv",'r') as f:
    reader = csv.reader(f)
    for row in reader:
...
fit1 = MLPRegressor(hidden_layer_sizes=(80,60), activation='relu',solver='adam',alpha=0.08,max_iter=500)
