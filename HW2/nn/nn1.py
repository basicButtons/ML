...
with open("/Users/maxuan/Desktop/course/ML/HW2/data/train0.csv",'r') as f:
    reader = csv.reader(f)
    for row in reader:
        train_x.append(row[0:20])
        train_y.append(row[20])

with open("/Users/maxuan/Desktop/course/ML/HW2/data/test_0.csv",'r') as f:
    reader = csv.reader(f)
    for row in reader:
...
fit1 = MLPRegressor(hidden_layer_sizes=(50), activation='relu',solver='adam',alpha=0.05,max_iter=700)
